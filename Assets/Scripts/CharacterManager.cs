...
public class CharacterManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // UI setup removed - using CategoryButtonHandler instead
    ...
    /// <summary>
    /// Refresh UI with current character data - DISABLED (using CategoryButtonHandler instead)
    /// </summary>
    [ContextMenu("Refresh UI")]
    public void RefreshUI()
    {
        Debug.Log("UI refresh disabled - using CategoryButtonHandler instead");
        
        // CategoryButtonHandler will handle UI updates automatically
        CategoryButtonHandler handler = FindObjectOfType<CategoryButtonHandler>();
        if (handler != null)
        {
            Debug.Log("CategoryButtonHandler found - UI will be handled automatically");
        }
    }
