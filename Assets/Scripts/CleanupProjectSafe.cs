...
public class CleanupProjectSafe : MonoBehaviour
{
    public static void Execute()
    {
        Debug.Log("Starting safe project cleanup...");
        ...
        foreach (GameObject obj in allObjects)
        {
            ...
            // Add to delete list if not essential
            if (!shouldKeep)
            {
        ...
        Debug.Log($"Cleanup completed! Deleted {objectsToDelete.Count} GameObjects.");
